...
print("<tr><th><i class='fa fa-icon-user fa-lg'></i> Currently Logged User</th><td>".._SESSION["user"].."</td></tr>\n")
print("<tr><th><i class='fa fa-icon-time fa-lg'></i> Uptime</th><td>"..secondsToTime(info["uptime"]).."</td></tr>\n")
...
print("<tr><th><a href=http://twitter.github.io/><i class=\'fa fa-icon-twitter fa-lg'></i> Twitter Bootstrap</A></th><td>2.3.1</td></tr>\n")
