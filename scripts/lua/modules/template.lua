...
template = {
   ...
   ['PROC_CPU_ID'] = NTOP_BASE_ID+375,
   ['PROC_ACTUAL_MEMORY'] = NTOP_BASE_ID+376,
   ['PROC_PEAK_MEMORY'] = NTOP_BASE_ID+377,
   ['PROC_AVERAGE_CPU_LOAD'] = NTOP_BASE_ID+378,
   ['PROC_NUM_PAGE_FAULTS'] = NTOP_BASE_ID+379,
   -- HTTP
