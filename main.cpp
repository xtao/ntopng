...
static void help() {
  printf("ntopng %s v.%s (%s) - (C) 1998-13 ntop.org\n\n"
	 ...
	 "[--data-dir|-d] <path>              | Data directory (must be writable). Default: %s\n"
	 "[--categorization-key|-c] <key>     | Key used to access host categorization services (default: disabled). \n"
         "                                    | Please read README.categorization for more info.\n"
	 "[--http-port|-w] <http port>        | HTTP port. Default: %u\n"
	 "[--local-networks|-m] <local nets>  | List of local networks (e.g. -m \"192.168.0.0/24,172.16.0.0/16\")\n"
	 "[--ndpi-protocols|-p] <file>.protos | Specify a nDPI protocol file (eg. protos.txt)\n"
	 "[--redis|-r] <redis host[:port]>    | Redis host[:port]\n"
	 "[--core-affinity|-g] <cpu core id>  | Bind the capture/processing thread to a specific CPU Core\n"
